...
<meta name="keywords" content="destinations,travel, reviews">
     ...
     <header>
         ...
         <h1 class="replace">
	     	<a href="#">
                ...
                " alt="saful mulk" title="lake saiful mulk" id="mulk">
	     	</a>
	     </h1> 
	     </figure>  
    ...
    <div class="custom-menu-class" id="test">
		...
		<div class="main" id="main">
		         <p>
		             ...
		             <img id="I" alt="wonders" title="wonders of the world"  src ="<?php echo get_template_directory_uri(); ?>/images/t.jpg"  > 
