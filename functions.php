...
function add_theme_style() {
  ...
  wp_enqueue_style( 'foundation-css', get_template_directory_uri() . '/css/foundation.css',false,'1.1','all');
  wp_enqueue_style( 'app-css', get_template_directory_uri() . '/css/app.css',false,'1.1','all');
...
function add_favicon() {
	echo '<link rel="shortcut icon" type="image/x-icon" href="'.get_template_directory_uri().'/travelicon.png" />';
}
