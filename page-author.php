...
if (!userHasRole('Account Administrator'))
{
  ...
  include '../cms/wp-content/themes/travel/admin/accessdenied.html.php';
  exit();
}
...
if (isset($_GET['add']))
{
  ...
  include $_SERVER['DOCUMENT_ROOT'] . '../cms/wp-content/themes/travel/includes/db.inc.php';
  ...
  catch (PDOException $e)
  {
    ...
    include 'admin/author/error.html.php';
    exit();
  }
  ...
  include 'admin/author/form.html.php';
  exit();
}
...
if (isset($_GET['addform']))
{
  ...
  if ($_POST['password'] != '')
  {
    $password = md5($_POST['password'] . 'cms');
...
include 'admin/author/authors.html.php';
